      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <!-- 显示绿色提示消息 -->
            <div v-if="formData.reason.length >= 10 && formData.reason.toLowerCase().includes('friend') && !errors.reason" class="text-success">
